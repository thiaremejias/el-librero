var RegionesYcomunas = {
	...
	"regiones": [{
        ...
        "NombreRegion": "Región nueva nueva",
			"comunas": ["hola", "chao", "mañana"]
    }]
}
...
jQuery(document).ready(function () {
	...
	//validación de seleccion de una region y ciudad
	...
	jQuery('#comunas').change(function () {
		if (jQuery(this).val() == 'sin-region') {
        	...
        	mensajeCiudad.innerHTML='Debe seleccionar una Ciudad de la región.';
